...
public class Kundenverwaltung implements Serializable{
	 ...
	 * @return Kunde der entweder anhand seines Namens gefunden oder anhand einer Auswahl gewÃ¤hlt wird
	 */
	public Kunde kundeBestimmen(String name){

		Scanner sc = new Scanner(System.in);
		
		//HashMap wird angelegt die Alle Kunden speichert anhand eines Indexes mit dem der Nutzer spÃ¤ter die Auswahl treffen soll
		...
		//Versuche aus der nÃ¤chsten Zeile einen Integer wert zu bekommen. Nutzer soll den entsprechenden Kunden anhand von dessen Index auswÃ¤hlen
